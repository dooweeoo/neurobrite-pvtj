...
if experiment == 'visual_p300_stripes' or experiment == 'exp1' or experiment == 'exp2' or experiment == 'exp3':
	recording_path = os.path.join(os.path.expanduser("~"), "eeg-notebooks", "data", "visual", "P300", "subject" + str(subject), "session" + str(session), "recording_" + experiment + ("_%s.csv" % strftime("%Y-%m-%d-%H.%M.%S", gmtime())))
